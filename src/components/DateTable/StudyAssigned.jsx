...
const StudyAssigned = () => {
  ...
  useEffect(() => {
    fetch(`${import.meta.env.VITE_API_URL}/assignedStudyNumbers?page=${page}&&sort=desc`, {
      method: "GET",
      credentials : "include",
    })
      .then((res) => res.json())
        ...
        <div className="oreders-report-tables-card-container">
          <table className="dashboard-table-main">
            <thead className="dash-b-table-head">
              ...
              <th className="th-name-card f1 center">Create Study</th>
